...
export const Footer: React.FC = () => {
    return (
        <footer id="footer" className="bg-black py-10 md:py-20 border-t border-white/5 relative">
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12 border-b border-white/5 pb-10 md:pb-12 mb-10 md:mb-12 reveal">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full md:w-auto text-center md:text-left">
                        <div>
                            <h4 className="text-white font-serif text-lg mb-4 md:mb-6">Contact B2B</h4>
                            <ul className="space-y-3 md:space-y-4 text-sm text-lore-muted font-light flex flex-col items-center md:items-start">
                        ...
                        <div>
                            <h4 className="text-white font-serif text-lg mb-4 md:mb-6">Liens</h4>
                            <ul className="space-y-3 md:space-y-4 text-sm text-lore-muted font-light">
