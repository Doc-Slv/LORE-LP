    ...
    <div className="min-h-screen bg-lore-main overflow-hidden pb-20">
      ...
      <div className="relative h-[80vh] w-full flex items-end">
        ...
        <div className="container mx-auto px-6 pb-20 relative z-10">
            <Link to="/univers" className="inline-flex items-center gap-2 text-white/70 hover:text-lore-gold transition-colors text-xs uppercase tracking-widest mb-8 backdrop-blur-md bg-black/30 px-4 py-2 rounded-full border border-white/10">
